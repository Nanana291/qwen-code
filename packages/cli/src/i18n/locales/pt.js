...
export default {
  ...
  'Run qwen-custom --debug to see error logs':
    'Execute qwen-custom --debug para ver os logs de erro',
  ...
  'You can resume a previous conversation by running qwen-custom --continue or qwen-custom --resume.':
    'Você pode retomar uma conversa anterior executando qwen-custom --continue ou qwen-custom --resume.',
  ...
  '  qwen-custom auth qwen-oauth     - Authenticate with Qwen OAuth (free tier)':
    '  qwen-custom auth qwen-oauth     - Autenticar com Qwen OAuth (gratuito)',
  '  qwen-custom auth coding-plan      - Authenticate with Alibaba Cloud Coding Plan\n':
    '  qwen-custom auth coding-plan      - Autenticar com Alibaba Cloud Coding Plan\n',
  'Or simply run:': 'Ou simplesmente execute:',
  '  qwen-custom auth                - Interactive authentication setup\n':
    '  qwen-custom auth                - Configuração interativa de autenticação\n',
  ...
  '  Run `qwen-custom auth coding-plan` to re-configure.\n':
    '  Execute `qwen-custom auth coding-plan` para reconfigurar.\n',
