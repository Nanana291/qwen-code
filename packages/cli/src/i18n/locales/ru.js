...
export default {
  ...
  'You can resume a previous conversation by running qwen-custom --continue or qwen-custom --resume.':
    'Вы можете продолжить предыдущий разговор, запустив qwen-custom --continue или qwen-custom --resume.',
  ...
  'Run qwen-custom --debug to see error logs':
    'Запустите qwen-custom --debug для просмотра журналов ошибок',
  ...
  '  qwen-custom auth qwen-oauth     - Authenticate with Qwen OAuth (free tier)':
    '  qwen-custom auth qwen-oauth     - Аутентификация через Qwen OAuth (бесплатно)',
  '  qwen-custom auth coding-plan      - Authenticate with Alibaba Cloud Coding Plan\n':
    '  qwen-custom auth coding-plan      - Аутентификация через Alibaba Cloud Coding Plan\n',
  'Or simply run:': 'Или просто выполните:',
  '  qwen-custom auth                - Interactive authentication setup\n':
    '  qwen-custom auth                - Интерактивная настройка аутентификации\n',
  ...
  '  Run `qwen-custom auth coding-plan` to re-configure.\n':
    '  Выполните `qwen-custom auth coding-plan` для повторной настройки.\n',
